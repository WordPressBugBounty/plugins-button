...
<div class="buton_layout_container">
	...
	<label for="simple_button">
		...
		<a target="_blank" href="<?php echo esc_url('https://burgerthemes.com/demo/pro/button/'); ?>"><?php esc_html_e( 'Demo', 'button' ); ?></a>
	</label>
	
	<label for="2d_transitions">
		<div class="wdbutton_ribbon"><a target="_blank" href="<?php echo esc_url('https://burgerthemes.com/button-pro'); ?>"><span><?php esc_html_e( 'Premium', 'button' ); ?></span></a></div>
		...
		<a target="_blank" href="<?php echo esc_url('https://burgerthemes.com/demo/pro/button/2d-3d/'); ?>"><?php esc_html_e( 'Demo', 'button' ); ?></a>
	</label>
	...
	<label for="border_transitions">
		...
		<a target="_blank" href="<?php echo esc_url('https://burgerthemes.com/demo/pro/button/bg-transition/'); ?>"><?php esc_html_e( 'Demo', 'button' ); ?></a>
	</label>
	...
	<label for="icons">
		...
		<a target="_blank" href="<?php echo esc_url('https://burgerthemes.com/demo/pro/button/icon-type-button/'); ?>"><?php esc_html_e( 'Demo', 'button' ); ?></a>
	</label>	
	...
	<label for="icon_with_text">
		...
		<a target="_blank" href="<?php echo esc_url('https://burgerthemes.com/demo/pro/button/social-button-sets/'); ?>"><?php esc_html_e( 'Demo', 'button' ); ?></a>
	</label>
	...
	<label for="dropdown">
		...
		<a target="_blank" href="<?php echo esc_url('https://burgerthemes.com/demo/pro/button/drop-down/'); ?>"><?php esc_html_e( 'Demo', 'button' ); ?>	</a>
	</label>
